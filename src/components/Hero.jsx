      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-6">
        <div className="max-w-2xl">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }} className="mt-4 text-lg sm:text-xl text-white/80">
            Unisciti a un mondo dove gaming e benessere si incontrano. Esperienze interattive, community, e programmi pensati per te.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="mt-8 flex flex-col sm:flex-row gap-3">
            <a href="#programs" className="rounded-xl bg-gradient-to-r from-fuchsia-500 to-violet-600 px-6 py-3 text-white font-semibold shadow-lg hover:shadow-fuchsia-500/30 transition-shadow">Scopri i programmi</a>
            <a href="#community" className="rounded-xl bg-white/10 backdrop-blur px-6 py-3 text-white font-semibold border border-white/10 hover:bg-white/15">Entra nella community</a>
          </motion.div>
        </div>
      </div>
    </section>
